// // DEPRECATED: This file is no longer in use. Using components/landing/LandingPage.tsx instead.
...
//             // If actively scrolling (higher threshold), don't snap - let user continue naturally
//             if (velocity > 800) {
//               return progress;
//             }
...
//             // Calculate if we're in an overlap zone (between sections)
//             const currentSectionIndex = Math.floor(progress * totalSections);
//             const sectionProgress = (progress * totalSections) % 1;
            
//             // Apply uniform overlap detection to all section transitions (25-75%)
//             const isInOverlapZone = sectionProgress > 0.25 && sectionProgress < 0.75;
            
//             // If stopped in overlap zone (low velocity), auto-correct to nearest section
//             if (velocity < 50 && isInOverlapZone) {
//               // Snap to nearest section center to avoid text overlap
//               return targetSnap;
//             }

//             // Only snap if we're close enough to a snap point (within 15% of section)
//             // This prevents snapping during mid-scroll transitions
//             const distanceToSnap = Math.abs(targetSnap - progress);
//             const snapThreshold = segment * 0.15;
            
//             if (distanceToSnap > snapThreshold) {
//               return progress; // Don't snap, let user continue scrolling
//             }

//             return targetSnap;
//           },
//           duration: animConfig.snapDuration, // Device-optimized snap duration
//           delay: 0.15, // Slight delay to detect if user truly stopped
//           ease: "power2.inOut",
//           inertia: true // Allow natural scroll momentum
//         },
